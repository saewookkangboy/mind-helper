/**
 * 도메인별 소스 로더 (Orchestrator 파이프라인 입력용)
 * 6대 도메인(사주, 심리상담, MBTI, 타로, 버크만, 다크 심리학)별 컨텍스트 수집.
 * 파이프라인에서 각 컨텍스트에 사용자 질문을 붙인 뒤 AI 오케스트레이터에 전달하며,
 * AI는 섹션과 소스를 1:1로 매핑해 각 섹션 결과를 생성합니다.
 */
